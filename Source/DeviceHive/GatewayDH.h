...
public:
   ...
   void AsyncRegister(GatewayListener::instrOnRegisterCB inRegisterCallback = 0);// Register the instrument
...
private: // DH-device interface of the instrument   
