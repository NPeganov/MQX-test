...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/bsp/bsp.lib(vectors.o)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/psp/psp.lib
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/psp/psp.lib(linker_symbols.o)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/bsp/bsp.lib(vectors.o)
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/psp/psp.lib
LIBRARIES += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/psp/psp.lib(linker_symbols.o)
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/debug/bsp/Sources
...
INCLUDE += $(MQX_ROOTDIR)/lib/twrk60f120m.uv4/release/bsp/Sources
