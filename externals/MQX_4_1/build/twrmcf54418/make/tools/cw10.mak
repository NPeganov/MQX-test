...
# common settings
AS_FLAGS += -proc 54418 -sym full -msgstyle parseable -nosyspath -prefix "$(MQX_ROOTDIR)/mqx/source/psp/coldfire/psp_regabi.h" 
CC_FLAGS += -noscheduling -nopeephole -proc 54418 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c99 -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl -prefix "$(MQX_ROOTDIR)/mqx/source/psp/coldfire/psp_regabi.h" 
CX_FLAGS += -noscheduling -nopeephole -proc 54418 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c++ -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl -prefix "$(MQX_ROOTDIR)/mqx/source/psp/coldfire/psp_regabi.h" 
...
AS_DEFINE += _EWL_C99=1 _EWL_FLOATING_POINT=1 _EMBEDDED_WARRIOR_CTYPE=0 __CODEWARRIOR__=1 
CC_DEFINE += _EWL_C99=1 _EWL_FLOATING_POINT=1 _EMBEDDED_WARRIOR_CTYPE=0 __CODEWARRIOR__=1 
CX_DEFINE += _EWL_C99=1 _EWL_FLOATING_POINT=1 _EMBEDDED_WARRIOR_CTYPE=0 __CODEWARRIOR__=1 
...
CC_FLAGS += -noscheduling -nopeephole -proc 54418 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c99 -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl 
CX_FLAGS += -noscheduling -nopeephole -proc 54418 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c++ -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl 
LD_FLAGS += -proc 54418 -sym full -msgstyle parseable -lavender model=c9x ,print=int ,scan=int ,io=raw -nostdlib -m ___boot -map -map closure -srec -sreclength 80 -sreceol dos -w off 
AR_FLAGS += -proc 54418 -library -sym full -msgstyle parseable -nostdlib -map -srec -sreclength 80 -sreceol dos -keep off -w on 
AS_DEFINE += _EWL_C99=1 _EWL_FLOATING_POINT=1 _EMBEDDED_WARRIOR_CTYPE=0 __CODEWARRIOR__=1 
