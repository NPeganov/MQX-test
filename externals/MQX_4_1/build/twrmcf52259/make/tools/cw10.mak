...
# common settings
AS_FLAGS += -proc 52259 -sym full -msgstyle parseable -nosyspath -prefix "$(MQX_ROOTDIR)/mqx/source/psp/coldfire/psp_regabi.h" 
CC_FLAGS += -noscheduling -nopeephole -proc 52259 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c99 -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl -prefix "$(MQX_ROOTDIR)/mqx/source/psp/coldfire/psp_regabi.h" 
CX_FLAGS += -noscheduling -nopeephole -proc 52259 -fp soft -char unsigned -sym full -msgstyle parseable -nostdinc -nosyspath -enc ascii -opt space -inline on -align coldfire -model farCode -model farData -a6 -nocoloring -sdata 0 -Cpp_Exceptions off -RTTI off -enum int -str nopool -str reuse -ipa off -lang c++ -warn illpragmas -warn unwanted -warn missingreturn -warn extracomma -warn emptydecl -prefix "$(MQX_ROOTDIR)/mqx/source/psp/coldfire/psp_regabi.h" 
