...
# common settings
AS_FLAGS += --cpu Cortex-M4.fp --apcs=interwork --cpreproc --xref --li -g --diag_suppress=1609,1581 
CC_FLAGS += --cpu Cortex-M4.fp --diag_suppress=1296,186 --library_interface=armcc --library_type=standardlib --apcs=interwork --split_sections --li --c99 -g 
CX_FLAGS += --cpu Cortex-M4.fp --diag_suppress=1296,186 --library_interface=armcc --library_type=standardlib --apcs=interwork --split_sections --li --cpp -g 
LD_FLAGS += --cpu Cortex-M4.fp --remove --keep linker_symbols.o(KERNEL_DATA_START) --keep linker_symbols.o(KERNEL_DATA_END) --keep linker_symbols.o(BOOT_STACK) --keep vectors.o(.vectors_rom) --autoat --xref --summary_stderr --info summarysizes --map --callgraph --symbols --info sizes --info totals --info unused --info veneers --strict --diag_suppress=6314,6329 
