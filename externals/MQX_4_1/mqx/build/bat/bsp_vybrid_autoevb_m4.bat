...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_m4\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_m4\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_m4\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_m4\vybrid_autoevb_m4.h" "%OUTPUTDIR%\vybrid_autoevb_m4.h" /Y
copy "%ROOTDIR%\mqx\source\io\lwgpio\lwgpio_vgpio.h" "%OUTPUTDIR%\lwgpio_vgpio.h" /Y
copy "%ROOTDIR%\config\vybrid_autoevb_m4\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_m4\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_m4\iar\ram.icf" "%OUTPUTDIR%\ram.icf" /Y
goto copy_end
...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_m4\ds5\ram.scf" "%OUTPUTDIR%\ram.scf" /Y
goto copy_end
...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_m4\gcc_arm\ram.ld" "%OUTPUTDIR%\ram.ld" /Y
goto copy_end
