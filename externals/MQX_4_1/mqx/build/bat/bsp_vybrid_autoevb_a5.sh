...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/vybrid_autoevb_a5/iar/ddr.icf" "${OUTPUTDIR}/ddr.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/vybrid_autoevb_a5/iar/intram.icf" "${OUTPUTDIR}/intram.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/vybrid_autoevb_a5/iar/vybrid_autoevb_a5_ddr.mac" "${OUTPUTDIR}/vybrid_autoevb_a5_ddr.mac"
