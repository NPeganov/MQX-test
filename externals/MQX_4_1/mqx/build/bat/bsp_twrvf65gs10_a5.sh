...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_a5/iar/ddr.icf" "${OUTPUTDIR}/ddr.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_a5/iar/intram.icf" "${OUTPUTDIR}/intram.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrvf65gs10_a5/iar/vf65gs10_a5_ddr.mac" "${OUTPUTDIR}/vf65gs10_a5_ddr.mac"
