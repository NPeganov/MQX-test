...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
for /R "%ROOTDIR%\mqx\build\cw10gcc\bsp_twrk20d72m\Generated_Code" %%f in (*.h) do copy %%f "%OUTPUTDIR%\Generated_Code\"
for /R "%ROOTDIR%\mqx\build\cw10gcc\bsp_twrk20d72m\Sources" %%f in (*.h) do copy %%f "%OUTPUTDIR%\Sources\"
