...
mkdir -p "${OUTPUTDIR}"
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_qspi.h" "${OUTPUTDIR}/mcf5xxx_qspi.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf522xx_adc.h" "${OUTPUTDIR}/mcf522xx_adc.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_minifb.h" "${OUTPUTDIR}/mcf5xxx_minifb.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf522x_usbotg.h" "${OUTPUTDIR}/mcf522x_usbotg.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf52xx_rtc.h" "${OUTPUTDIR}/mcf52xx_rtc.h"
cp -f "${ROOTDIR}/mqx/source/include/mmu.h" "${OUTPUTDIR}/mmu.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf522xx_eport.h" "${OUTPUTDIR}/mcf522xx_eport.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_fec.h" "${OUTPUTDIR}/mcf5xxx_fec.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf52xx_i2c.h" "${OUTPUTDIR}/mcf52xx_i2c.h"
cp -f "${ROOTDIR}/mqx/source/include/fio.h" "${OUTPUTDIR}/fio.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf52xx_cfm.h" "${OUTPUTDIR}/mcf52xx_cfm.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf52xx_ictl.h" "${OUTPUTDIR}/mcf52xx_ictl.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf52xx_fcan.h" "${OUTPUTDIR}/mcf52xx_fcan.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf52xx_uart.h" "${OUTPUTDIR}/mcf52xx_uart.h"
cp -f "${ROOTDIR}/mqx/source/include/lwevent.h" "${OUTPUTDIR}/lwevent.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5225.h" "${OUTPUTDIR}/mcf5225.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf522xx_pit.h" "${OUTPUTDIR}/mcf522xx_pit.h"
