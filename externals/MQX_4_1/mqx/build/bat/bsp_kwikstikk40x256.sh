...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/kwikstikk40x256/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/kwikstikk40x256/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
cp -f "${ROOTDIR}/mqx/source/io/hmi/TSS/lib_iar/TSS_KXX_M4.a" "${OUTPUTDIR}/tss.a"
mkdir -p "${OUTPUTDIR}/Generated_Code"
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/kwikstikk40x256/gcc_cw/intflash.ld" "${OUTPUTDIR}/intflash.ld"
...
if [ "${TOOL}" = "uv4" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/kwikstikk40x256/uv4/intflash.scf" "${OUTPUTDIR}/intflash.scf"
cp -f "${ROOTDIR}/mqx/source/io/hmi/TSS/lib_uv4/TSS_KXX_M4.lib" "${OUTPUTDIR}/tss.lib"
mkdir -p "${OUTPUTDIR}/Generated_Code"
mkdir -p "${OUTPUTDIR}/Sources"
:
fi
