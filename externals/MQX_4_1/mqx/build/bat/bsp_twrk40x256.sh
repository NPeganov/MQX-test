...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/gcc_cw/intflash.ld" "${OUTPUTDIR}/intflash.ld"
...
if [ "${TOOL}" = "uv4" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk40x256/uv4/intflash.scf" "${OUTPUTDIR}/intflash.scf"
