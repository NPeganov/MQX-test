...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/reg_nfc.h" "${OUTPUTDIR}/reg_nfc.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/reg_enet.h" "${OUTPUTDIR}/reg_enet.h"
cp -f "${ROOTDIR}/mqx/source/include/edserial.h" "${OUTPUTDIR}/edserial.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp_comp.h" "${OUTPUTDIR}/psp_comp.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp_cpu.h" "${OUTPUTDIR}/psp_cpu.h"
cp -f "${ROOTDIR}/mqx/source/include/lwmsgq.h" "${OUTPUTDIR}/lwmsgq.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp_rev.h" "${OUTPUTDIR}/psp_rev.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp_cpudef.h" "${OUTPUTDIR}/psp_cpudef.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf54xx_sdramc.h" "${OUTPUTDIR}/mcf54xx_sdramc.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp_supp.h" "${OUTPUTDIR}/psp_supp.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp_abi.h" "${OUTPUTDIR}/psp_abi.h"
cp -f "${ROOTDIR}/mqx/source/include/event.h" "${OUTPUTDIR}/event.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp_time.h" "${OUTPUTDIR}/psp_time.h"
cp -f "${ROOTDIR}/mqx/source/include/log.h" "${OUTPUTDIR}/log.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_esw.h" "${OUTPUTDIR}/mcf5xxx_esw.h"
cp -f "${ROOTDIR}/mqx/source/include/queue.h" "${OUTPUTDIR}/queue.h"
cp -f "${ROOTDIR}/mqx/source/include/mutex.h" "${OUTPUTDIR}/mutex.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/coldfire.h" "${OUTPUTDIR}/coldfire.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/asm_mac.h" "${OUTPUTDIR}/asm_mac.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf54xx_uart.h" "${OUTPUTDIR}/mcf54xx_uart.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_usbotg.h" "${OUTPUTDIR}/mcf5xxx_usbotg.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_pit.h" "${OUTPUTDIR}/mcf5xxx_pit.h"
cp -f "${ROOTDIR}/mqx/source/include/klog.h" "${OUTPUTDIR}/klog.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf544xx_adc.h" "${OUTPUTDIR}/mcf544xx_adc.h"
cp -f "${ROOTDIR}/config/common/small_ram_config.h" "${OUTPUTDIR}/small_ram_config.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5441.h" "${OUTPUTDIR}/mcf5441.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psptypes.h" "${OUTPUTDIR}/psptypes.h"
cp -f "${ROOTDIR}/mqx/source/include/lwsem.h" "${OUTPUTDIR}/lwsem.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_fb.h" "${OUTPUTDIR}/mcf5xxx_fb.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp_math.h" "${OUTPUTDIR}/psp_math.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf54xx_ictl.h" "${OUTPUTDIR}/mcf54xx_ictl.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_esdhc.h" "${OUTPUTDIR}/mcf5xxx_esdhc.h"
...
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf54xx_fcan.h" "${OUTPUTDIR}/mcf54xx_fcan.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf54xx_i2c.h" "${OUTPUTDIR}/mcf54xx_i2c.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_irtc.h" "${OUTPUTDIR}/mcf5xxx_irtc.h"
cp -f "${ROOTDIR}/mqx/source/include/lwevent.h" "${OUTPUTDIR}/lwevent.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf5xxx_dspi.h" "${OUTPUTDIR}/mcf5xxx_dspi.h"
cp -f "${ROOTDIR}/mqx/source/include/eds.h" "${OUTPUTDIR}/eds.h"
cp -f "${ROOTDIR}/mqx/source/include/lwmem.h" "${OUTPUTDIR}/lwmem.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/psp.h" "${OUTPUTDIR}/psp.h"
cp -f "${ROOTDIR}/mqx/source/include/message.h" "${OUTPUTDIR}/message.h"
cp -f "${ROOTDIR}/mqx/source/include/pcb.h" "${OUTPUTDIR}/pcb.h"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/mcf54xx_ccm.h" "${OUTPUTDIR}/mcf54xx_ccm.h"


# cw10 files
if [ "${TOOL}" = "cw10" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/psp/coldfire/cw_comp.h" "${OUTPUTDIR}/cw_comp.h"
:
fi
