...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
...
copy "%ROOTDIR%\config\vybrid_autoevb_a5\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\vybrid_autoevb_a5.h" "%OUTPUTDIR%\vybrid_autoevb_a5.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\iar\ddr.icf" "%OUTPUTDIR%\ddr.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\iar\intram.icf" "%OUTPUTDIR%\intram.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\iar\vybrid_autoevb_a5_ddr.mac" "%OUTPUTDIR%\vybrid_autoevb_a5_ddr.mac" /Y
goto copy_end
...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\ds5\intram.scf" "%OUTPUTDIR%\intram.scf" /Y
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\ds5\ddr.scf" "%OUTPUTDIR%\ddr.scf" /Y
goto copy_end
...
IF NOT EXIST "%OUTPUTDIR%\Generated_Code" mkdir "%OUTPUTDIR%\Generated_Code"
IF NOT EXIST "%OUTPUTDIR%\Sources" mkdir "%OUTPUTDIR%\Sources"
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\gcc_arm\intram.ld" "%OUTPUTDIR%\intram.ld" /Y
copy "%ROOTDIR%\mqx\source\bsp\vybrid_autoevb_a5\gcc_arm\ddr.ld" "%OUTPUTDIR%\ddr.ld" /Y
goto copy_end
