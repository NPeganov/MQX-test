...
for /R "%ROOTDIR%\mqx\build\cw10\bsp_twrmcf51jf\Generated_Code" %%f in (*.h) do copy %%f "%OUTPUTDIR%\Generated_Code\"
for /R "%ROOTDIR%\mqx\build\cw10\bsp_twrmcf51jf\Sources" %%f in (*.h) do copy %%f "%OUTPUTDIR%\Sources\"
