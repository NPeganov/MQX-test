...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/gcc_cw/intflash.ld" "${OUTPUTDIR}/intflash.ld"
...
if [ "${TOOL}" = "uv4" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk60f120m/uv4/intflash.scf" "${OUTPUTDIR}/intflash.scf"
