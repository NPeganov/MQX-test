...
if [ "${TOOL}" = "iar" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk70f120m/iar/intflash_ddrdata.icf" "${OUTPUTDIR}/intflash_ddrdata.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk70f120m/iar/intflash_sramdata.icf" "${OUTPUTDIR}/intflash_sramdata.icf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk70f120m/iar/intram.icf" "${OUTPUTDIR}/intram.icf"
...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk70f120m/gcc_cw/intflash_sramdata.ld" "${OUTPUTDIR}/intflash_sramdata.ld"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk70f120m/gcc_cw/intflash_ddrdata.ld" "${OUTPUTDIR}/intflash_ddrdata.ld"
...
if [ "${TOOL}" = "uv4" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk70f120m/uv4/intflash_sramdata.scf" "${OUTPUTDIR}/intflash_sramdata.scf"
cp -f "${ROOTDIR}/mqx/source/bsp/twrk70f120m/uv4/intflash_ddrdata.scf" "${OUTPUTDIR}/intflash_ddrdata.scf"
