...
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/psp/cortex_m/compiler/gcc_cw/asm_mac.h" "${OUTPUTDIR}/asm_mac.h"
cp -f "${ROOTDIR}/mqx/source/psp/cortex_m/compiler/gcc_cw/comp.h" "${OUTPUTDIR}/comp.h"
:
fi
...
if [ "${TOOL}" = "uv4" ]; then
mkdir -p "${OUTPUTDIR}/"
cp -f "${ROOTDIR}/mqx/source/psp/cortex_m/compiler/rv_uv4/asm_mac.h" "${OUTPUTDIR}/asm_mac.h"
cp -f "${ROOTDIR}/mqx/source/psp/cortex_m/compiler/rv_uv4/comp.h" "${OUTPUTDIR}/comp.h"
:
fi
