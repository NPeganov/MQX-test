...
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/debug/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/debug/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/release/mfs/mfs.a
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/release/shell/shell.a
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/debug/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/debug/shell
...
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/release/mfs
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_a5.iar/release/shell
