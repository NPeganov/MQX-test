...
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_m4.iar/debug/usb/usbh.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(MQX_ROOTDIR)/lib/vybrid_autoevb_m4.iar/release/usb/usbh.a
endif
...
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_m4.iar/debug/usb
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(MQX_ROOTDIR)/lib/vybrid_autoevb_m4.iar/release/usb
endif
